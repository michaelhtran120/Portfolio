        ...
        <Row className='align-items-center justify-content-around'>
          ...
          <Col lg={6} className='d-flex flex-column justify-content-center pt-5 pt-sm-0'>
            ...
            <ScrollAnimation
              ...
              animateOnce={true}>
              <p className='lh-lg'>
                A creative professional with a strong analytical prowess and problem-solving
                capacity is interested in growing his skills and knowledge through collaboration
                with both internal and external stakeholders to effectively plan, create, develop,
                and launch products.
              </p>
              <p className='lh-lg'>
                Completed Nucamp full stack boot camp in February and currently working as a front
                end developer intern with Biscuits N Groovy.
              </p>
              <p className='lh-lg'>
                Some interests of mine are gaming (video/board), music, fitness, photography,
                cooking, and dance. Always open to learning and exploring new things!
              </p>
              <p>
                Visit my{' '}
              ...
              <p className='lh-lg'>
                If you would like to ask me questions about my work or just get to know me, please
                contact me using the form below. I will get back to you as soon as possible and we
                can set up a remote coffee meet up!
              </p>
            </ScrollAnimation>
          </Col>
        </Row>
